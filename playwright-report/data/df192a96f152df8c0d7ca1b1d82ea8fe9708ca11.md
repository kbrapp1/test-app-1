...
- Name: FAQ Management - Critical User Workflows >> should handle FAQ deletion correctly
- Location: D:\Projects\test-app-1\tests\e2e\chatbot-widget\faq-management.spec.ts:138:7
...
Call log:
  ...
  - waiting for locator('h1')
    6 × locator resolved to <h1 class="text-lg font-semibold text-gray-900">Chatbot Widget</h1>

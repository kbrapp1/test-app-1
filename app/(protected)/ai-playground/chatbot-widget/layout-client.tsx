...
/**
 * Chatbot Widget Layout Client Component
 * 
 * AI INSTRUCTIONS:
 * - Handle client-side navigation and active state
 * - Render navigation and content layout
 * - Only rendered after server-side feature flag check passes
 */
export function ChatbotWidgetLayoutClient({ children }: { children: ReactNode }) {

...
describe('UserProfileProvider', () => {
  ...
  describe('Initial Load', () => {
    it('should start with loading state', async () => {
      // The UserProfileProvider starts with loading: true and isLoading: true from AuthenticationProvider
      // This test verifies that the initial render shows loading state
      ...
      // The component should eventually load (even if very quickly in tests)
      await waitFor(() => {
  ...
  describe('Browser Focus Scenarios', () => {
    it('should handle multiple rapid auth state changes gracefully', async () => {
      ...
      // Simulate rapid browser focus/unfocus events with no user change
      triggerAuthStateChange('TOKEN_REFRESHED', null);
      triggerAuthStateChange('TOKEN_REFRESHED', null);
      triggerAuthStateChange('TOKEN_REFRESHED', null);
      ...
      // Should not have fetched profile since no user
      expect(mockQueryBuilder.single).not.toHaveBeenCalled();
    });

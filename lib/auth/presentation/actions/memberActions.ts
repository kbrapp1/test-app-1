...
/**
 * Member Management Actions - Presentation Layer
 * 
 * AI INSTRUCTIONS:
 * - Presentation layer component for member management server actions
 * - Uses composition root for dependency injection
 * - Maintains all existing functionality with proper DDD structure
 * - Single responsibility: Member invitation and management actions
 */

...
/**
 * SortControl - Domain-Driven Sort Control Component
 * 
 * This component demonstrates proper DDD presentation patterns:
 * - Clean interface with domain-specific sorting props
 * - Handles sort field and order selection with predefined options
 * - Proper state management for sort controls
 * - Type-safe sorting with business rules validation
 * - Consistent UI patterns for filter controls
 */

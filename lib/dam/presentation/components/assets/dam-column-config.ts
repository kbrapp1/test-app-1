...
/**
 * Domain configuration interface for DAM table columns
 * Defines structure for asset and folder list table display
 */
...
/**
 * Domain table column configurations for DAM asset/folder list
 * Defines responsive design, styling, and asset-specific columns
 */

...
import { NetworkMonitorHeader } from '@/lib/monitoring/presentation/components/network-analysis/NetworkMonitorHeader';

const meta: Meta<typeof NetworkMonitorHeader> = {
  title: 'Monitoring/Network Analysis/NetworkMonitorHeader',
  component: NetworkMonitorHeader,
  parameters: {
    layout: 'padded',
    docs: {
      description: {

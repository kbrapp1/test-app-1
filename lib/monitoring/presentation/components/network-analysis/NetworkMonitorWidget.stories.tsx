...
import { NetworkMonitorWidget } from '@/lib/monitoring/presentation/components/network-analysis/NetworkMonitorWidget';

const meta: Meta<typeof NetworkMonitorWidget> = {
  title: 'Monitoring/Network Analysis/NetworkMonitorWidget',

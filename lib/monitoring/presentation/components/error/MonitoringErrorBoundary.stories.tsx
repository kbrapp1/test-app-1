...
import { MonitoringErrorBoundary } from '@/lib/monitoring/presentation/components/error/MonitoringErrorBoundary';

const meta: Meta<typeof MonitoringErrorBoundary> = {
  title: 'Monitoring/Error/MonitoringErrorBoundary',
  component: MonitoringErrorBoundary,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component: 'A monitoring component for error.',
      },
    },
  },
  tags: ['autodocs'],

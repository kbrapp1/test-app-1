...
import { ChatSimulationContext, SimulatedUserProfile as _SimulatedUserProfile, TestingGoal } from '../../../domain/value-objects/simulation/ChatSimulationContext';
...
export class ChatSimulationService implements IChatSimulationService {
  ...
  private async generateLiveResponse(message: string, _simulation: ChatSimulation): Promise<string> {

...
- Name: FAQ Management - Critical User Workflows >> should persist FAQ when user fills form and saves without clicking Add FAQ button
- Location: D:\Projects\test-app-1\tests\e2e\chatbot-widget\faq-management.spec.ts:20:7

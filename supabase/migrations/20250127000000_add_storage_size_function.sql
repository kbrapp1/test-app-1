-- Add function to calculate storage size for knowledge vectors by organization and chatbot
-- NOTE: This function was added but later found to be redundant with existing get_vector_stats()
-- Keeping this migration for database consistency, function will be dropped in later migration
CREATE OR REPLACE FUNCTION get_knowledge_vectors_storage_size(
  org_id text,
  chatbot_id text
)
RETURNS bigint

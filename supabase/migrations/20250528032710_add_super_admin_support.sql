...
DROP POLICY "Organization members can access their org data in tags" ON public.tags;
...
DROP POLICY "Superusers can manage team user memberships" ON public.team_user_memberships;
...
DROP POLICY "Superusers can manage teams" ON public.teams;

...
function SubmitButton() {
  ...
  return (
    <Button 
      ...
      className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 ml-auto"
    >
    ...
    <form ref={formRef} action={formAction} className="space-y-4 flex flex-col">
      ...
      <div className="space-y-1">
        ...
        <Textarea 
            ...
            className="min-h-[100px] grow resize-none"

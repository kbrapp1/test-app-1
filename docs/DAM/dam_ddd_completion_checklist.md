...
- [ ] **Asset Entity Tests**
  ...
  - [ ] Test asset business rules
  - [ ] Test asset state changes
- [ ] **Folder Entity Tests**
  - [ ] Test folder creation validation
  - [ ] Test folder hierarchy rules
  - [ ] Test folder state changes
- [ ] **Value Object Tests**
  - [ ] Test any custom value objects
  - [ ] Test validation rules

### 2.2 Use Case Tests
- [ ] **Asset Use Cases**
  - [ ] `MoveAssetUseCase.test.ts`
  - [ ] `DeleteAssetUseCase.test.ts`
  - [ ] `RenameAssetUseCase.test.ts`
  - [ ] `GetAssetContentUseCase.test.ts`
  - [ ] `UpdateAssetTextUseCase.test.ts`
  - [ ] `CreateTextAssetUseCase.test.ts`
  - [ ] `UploadAssetUseCase.test.ts`
  - [ ] `GetAssetDetailsUseCase.test.ts`
- [ ] **Folder Use Cases**
  - [ ] `CreateFolderUseCase.test.ts`
  - [ ] `UpdateFolderUseCase.test.ts`
  - [ ] `DeleteFolderUseCase.test.ts`
  - [ ] `ListFoldersUseCase.test.ts`
  - [ ] `ListFolderContentsUseCase.test.ts`
  - [ ] `GetFolderPathUseCase.test.ts`
- [ ] **Tag Use Cases**
  - [ ] `CreateTagUseCase.test.ts`
  - [ ] `UpdateTagUseCase.test.ts`
  - [ ] `DeleteTagUseCase.test.ts`
  - [ ] `ListTagsUseCase.test.ts`
  - [ ] `AddTagToAssetUseCase.test.ts`
  - [ ] `RemoveTagFromAssetUseCase.test.ts`
- [ ] **Search Use Cases**
  - [ ] `SearchDamItemsUseCase.test.ts`
  - [ ] `ListTextAssetsUseCase.test.ts`
...
- [ ] **Tag Repository Tests**
  - [ ] Test CRUD operations
  - [ ] Test asset-tag relationships
  - [ ] Test error handling

### 2.4 Integration Tests
- [ ] **End-to-End DAM Workflows**
  - [ ] Upload → Tag → Move → Delete asset flow
  - [ ] Create folder → Upload to folder → Search flow
  - [ ] Text asset creation → Edit → Save flow
  - [ ] Tag filtering and search flow
